...
class Hash {
    ...
    private String hashDirPath;
    private String hashIndPath;
    ...
    public Hash(String hashDirPath, String hashIndPath) {
        this.hashDirPath = hashDirPath;
        this.hashIndPath = hashIndPath;
        criarArqDir();
        criarArqInd();
        try {
            arqDiretorio.seek(0);
    ...
    /**
     * <p>
     * reset-> reseta os arquivos de indice,de diretorio e a profundidade global
     * </p>
     */
    ...
    /**
     * <p>
     * criarArqDir -> Cria o arquivo de diretório Hash,e inicializa o cabeçalho e o
     * apontamento
    ...
    private void criarArqDir() {
        try {
            this.arqDiretorio = new RandomAccessFile(hashDirPath, "rw");
    ...
    /**
     * <p>
     * criarArqInd -> Cria o arquivo de Indices(Buckets) do Hash,e escreve algumas
     * informações
     * no primeiro bucket
     * </p>
     */
    private void criarArqInd() {
        try {
            this.arqIndices = new RandomAccessFile(hashIndPath, "rw");
    ...
    /**
     * <p>
     * fechar -> fecha a stream dos arquivos usados por esta classe
     * </p>
     */
    ...
    /**
     * <p>
     * calcPow2 -> calcula a potencia de dois com o expoente argumento dado
     * </p>
     * 
    ...
    /**
     * <p>
     * hashFunc -> calcula a função de hash = id mod 2^profGlobal para o id indicado
     * </p>
     * 
    ...
    /**
     * <p>
     * readBucketPos -> Le a posição de um bucket,baseado no arquivo de diretórios
     * </p>
     * 
    ...
    /*
     * aumentarProfGlobal -> aumenta a profundidade local,alocando ponteiros novos
     * no arquivo de
     * diretorios
     */
    ...
    /**
     * <p>
     * achaBucketEscreveAddr -> acha para qual bucket a proxima entrada do arquivo
     * de
     * diretorios deve apontar,e escreve o endereço dele
     * </p>
     * 
    ...
    /**
     * <p>
     * achaAddrBucketVazio ->Acha o endereço de byte do primeiro bucket com 0
     * elementos
     * </p>
    ...
    /**
     * <p>
     * inserir -> Insere um registro novo no bucket adequado
     * 
     * @param idShow   id do show,a ser usada na função de hashing para achar o
     *                 bucket
    ...
    /**
     * <p>
     * ler -> Devolve o endereço,no arquivo de banco de dados,
     * do filme cujo id é o argumento dado
     * </p>
     * 
    ...
    /**
     * <p>
     * mostrarInd -> mostra os filmes que estão no arquivo de indices,bucket a
     * bucket,sequencialmente.
     * Serve mais para debugging
     * </p>
     */
    ...
    /**
     * <p>
     * mostrarDir -> mostra os filmes que estão no arquivo de diretorios,bucket a
     * bucket,sequencialmente.
     * Serve mais para debugging
     * </p>
     */
    ...
    /**
     * <p>
     * deletar -> apaga um registro que exista do arquivo de indices
     * </p>
     * 
    ...
    /**
     * <p>
     * atualizar -> atualiza um registro no arquivo de indices do hash
     * </p>
     * 
