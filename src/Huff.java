...
public class Huff {
    ...
    /**
     * <p>
     * paraArvoreFinal->transforma a arvore binaria inicial na arvore do metodo
     * huffman<\p>
     */
    ...
    /**
     * <p>
     * constroiDictInicial->Constroi a arvore inicial a partir do arquivo fonte<\p>
     * 
    ...
    /**
     * <p>
     * comprimir-> Começa o processo de compressão do arquivo fonte pelo metodo
     * huffman<\p>
     * 
    ...
    public void comprimir(String s, String s2) {
        ...
        System.out.println("Tempo total para compactação pelo algoritmo Huffman foi de " + (tempoFin - tempoInic)
                + " milessegundos");
    ...
    /**
     * <p>
     * procuraInsereLL->Insere um elemento novo na linked list argumento de uma
     * forma ordenada<\p>
     * 
    ...
    public void procuraInsereLL(HuffDictNode element, LinkedList<HuffDictNode> list) {
        ...
        for (int size = list.size(), i = 0; !found && i < size; ++i) {
            if (element.quant < list.get(i).quant || (element.quant == list.get(i).quant && element.conteudo != null
                    && list.get(i).conteudo == null)) {
                found = true;
                list.add(i, element);
            } else if (i == size - 1) {
                found = true;
    ...
    /**
     * <p>
     * compress->Faz a compressão huffman propriamente dita,escrevendo ela em um
     * arquivo<\p>
     * 
    ...
    /**
     * <p>
     * criaHashMap->cria o hashmap com base na arvore de huffman<\p>
     */
    ...
    /**
     * <p>
     * procuraCodigo->desce a arvore huffman final,descobrindo os códigos para
     * escrever no hashmap
     * e os guarda<\p>
     * 
    ...
    /**
     * <p>
     * escreveHuffTree->escreve a arvore huffman no começo do arquivo comprimido<\p>
     * 
    ...
    /**
     * <p>
     * descomprimir->Começa o processo de descompressão huffman<\p>
     * 
    ...
    public void descomprimir(String s, String s2) {
        try {
            ...
            decompress(raf, s2);
            long tempoFin = System.currentTimeMillis();
            System.out.println("Tempo total para descompactação pelo algoritmo Huffman foi de " + (tempoFin - tempoInic)
                    + " milessegundos");
            raf.close();
        } catch (Exception e) {
    ...
    /**
     * <p>
     * constroiArvoreArquivo->constroi a arvore huffman a partir do arquivo
     * já comprimido<\p>
     * 
    ...
    /**
     * <p>
     * decompress->Faz a descompressão propriamente dita do arquivo argumento,para o
     * bd equivalente<\p>
     * 
    ...
    /**
     * <p>
     * byteToBits->adiciona os bits equivalentes do byte argumento a String
     * retornada<\p>
     * 
    ...
    /**
     * <p>
     * inverteHashMap->inverte o hashmap atributo desta classe,para realizar a
