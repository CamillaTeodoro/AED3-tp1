...
public class RB {
    ...
    /**
     * <p>
     * changePadrao-> muda os atributos desta classe relacionados ao padrao
     * a ser pesquisado<\p>
     * 
    ...
    /**
     * <p>
     * hashing1->Metodo chamado para calcular o valor de hash do padrao
    ...
    /**
     * <p>
     * procurar->Procura no db fornecido como string argumento,o padrao atributo
     * desta classe,
     * e no final escreve uma frase com o total de vezes o padrao foi encontrado,e
     * em quais registros ele foi encontrado<\p>
     * 
    ...
    /**
     * <p>
     * rollHash->faz o hash a partir da proxima posição do texto rapidamente,
    ...
    /**
     * <p>
     * checkP->checa se a string argumento é igual ao padrao<\p>
     * 
